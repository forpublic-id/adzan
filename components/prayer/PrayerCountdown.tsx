...
export function PrayerCountdown({ nextPrayer, className }: PrayerCountdownProps) {
  ...
  return (
    <Card className={`${className} ${isUrgent ? 'ring-2 ring-islamic-400 bg-islamic-50/50' : ''}`}>
      <CardContent className="p-6">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center space-x-4 mb-4">
            <div className="text-center">
              <div className={`text-3xl font-mono font-bold ${isUrgent ? 'text-islamic-600' : ''}`}>
            ...
            <div className={`text-2xl font-bold ${isUrgent ? 'text-islamic-600' : 'text-muted-foreground'}`}>
              :
            </div>
          ...
          <p className="text-sm text-muted-foreground">
            pada pukul <span className="font-semibold">
...
export function CountdownRing({ total, remaining, size = 120 }: CountdownRingProps) {
